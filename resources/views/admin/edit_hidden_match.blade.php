...
<div class="col-md-12 container">
    <form class="well form-horizontal" action="{{ route('update_hidden_match',$hidden_match->id) }}" method="POST">
    {{ csrf_field() }}
    <fieldset>
    ...
    <div class="form-group {{ $errors->has('home_team')? 'has-error': ''}}">
      ...
      <div class="col-md-4">
      <input  name="home_team" placeholder="Example: MU" class="form-control"  type="text" value="{{ $hidden_match->home_team }}">
    ...
    <div class="form-group {{ $errors->has('away_team')? 'has-error': ''}}">
      <label class="col-md-2 control-label" >Away Team</label> 
        <div class="col-md-4">
      <input name="away_team" placeholder="Exaple: MC" class="form-control"  type="text" value="{{ $hidden_match->away_team }}">
    ...
    <div class="form-group {{ $errors->has('start_at')? 'has-error': ''}}">
      ...
      <input  name="start_at" placeholder="Example: 2017-07-05 17:00:00" class="form-control"  type="text" value="{{ $hidden_match->start_at }}">
    ...
    <div class="form-group {{ $errors->has('end_at')? 'has-error': ''}}">
      <label class="col-md-2 control-label" >End At</label> 
        <div class="col-md-4">
      <input name="end_at" placeholder="Exaple: 2017-07-05 19:00:00" class="form-control"  type="text" value= "{{ $hidden_match->end_at }}" >
    ...
    <div class="form-group {{ $errors->has('close_at')? 'has-error': ''}}">
      <label class="col-md-2 control-label" >Close Bet At</label> 
        <div class="col-md-4">
      <input name="close_at" placeholder="Exaple: 2017-07-04 15:00:00" class="form-control"  type="text" value="{{ $hidden_match->close_at }}">
    ...
    <fieldset>
        ...
        <div class="form-group {{ $errors->has('home_rate')? 'has-error': ''}}">
          <label class="col-md-2 control-label" >Home Rate</label> 
            <div class="col-md-4">
          <input name="home_rate" placeholder="Exaple: 0.9" class="form-control"  type="text" value="{{ $hidden_match->home_rate }}">
        ...
        <div class="form-group {{ $errors->has('draw_rate')? 'has-error': ''}}">
          <label class="col-md-2 control-label" >Draw Rate</label> 
            <div class="col-md-4">
          <input name="draw_rate" placeholder="Exaple: 0.9" class="form-control"  type="text" value="{{ $hidden_match->draw_rate }}">
        ...
        <div class="form-group {{ $errors->has('away_rate')? 'has-error': ''}}">
          <label class="col-md-2 control-label" >Away Rate</label> 
            <div class="col-md-4">
          <input name="away_rate" placeholder="Exaple: 0.9" class="form-control"  type="text" value="{{ $hidden_match->away_rate }}">
